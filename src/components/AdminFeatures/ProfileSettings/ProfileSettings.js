...
import { API_URL, authFetch, logout } from "../../../utils/auth";
...
export default function ProfileSettings() {
  ...
  return (
    <MainLayout pageTitle="Profile Settings" pageSubtitle="Manage your admin account details">
